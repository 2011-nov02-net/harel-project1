    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationItems", x => new { x.LocationId, x.ItemId });
                    table.CheckConstraint("CK_Location_Inventory_Positive", "[ItemCount] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Order_MaxInventory", "[ItemCount] <= 20");
                    table.CheckConstraint("CK_Order_Inventory_Positive", "[ItemCount] > 0");
                    table.ForeignKey(
